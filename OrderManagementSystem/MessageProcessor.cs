...
using static OrderManagementSystem.Classes;
...
namespace OrderManagementSystem
{
    public class MessageProcessor
    {
        ...
        public static void ProcessCategoryMessage(Classes.Response response)
        {
            try
            {
        ...
        public static void ProcessOrderMessage(Classes.Response response)
        {
            try
            {
                switch (response.MessageAction)
        ...
        public static void ProcessProductMessage(Classes.Response response)
        {
            try
            {
                switch (response.MessageAction)
        ...
        public static void ProcessUserMessage(Classes.Response response)
        {
            try
            {
                switch (response.MessageAction)
